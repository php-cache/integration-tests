...
abstract class TaggableCachePoolTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @return TagAwarePool that is used in the tests
     */
    ...
    public function testMultipleTags()
    {
        ...
        $this->cache->save($this->cache->getItem('key1')->set('value')->tag(['tag1', 'tag2']));
        $this->cache->save($this->cache->getItem('key2')->set('value')->tag(['tag1', 'tag3']));
        $this->cache->save($this->cache->getItem('key3')->set('value')->tag(['tag2', 'tag3']));
        $this->cache->save($this->cache->getItem('key4')->set('value')->tag(['tag4', 'tag3']));
